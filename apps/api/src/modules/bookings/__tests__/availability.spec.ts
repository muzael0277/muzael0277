...
describe('intersectRanges', () => {
  it('keeps only the overlap', () => {
    expect(
      intersectRanges([{ start: '09:00', end: '18:00' }], [{ start: '10:00', end: '14:00' }]),
    ).toEqual([{ start: '10:00', end: '14:00' }]);
  });

  it('returns nothing when ranges do not meet', () => {
    expect(
      intersectRanges([{ start: '09:00', end: '12:00' }], [{ start: '13:00', end: '18:00' }]),
    ).toEqual([]);
  });
...
describe('hoursForWeekday', () => {
  it('reads a weekday out of the stored JSON shape', () => {
    expect(hoursForWeekday({ '1': [{ start: '10:00', end: '20:00' }] }, 1)).toEqual([
