import { z } from 'zod';
import {
  i18nTextSchema, i18nLongTextSchema, moneySchema, idSchema, imageUrlSchema,
  paginationSchema, customFieldsSchema,
} from './primitives';
...
export const adjustStockSchema = z.object({
  ...
  quantity: z.number().int().min(-1_000_000).max(1_000_000).refine((v) => v !== 0, 'Miqdor 0 bo‘lishi mumkin emas'),
