...
export const MODULES = [
  'CRM', 'CATALOG', 'SERVICES', 'ORDERS', 'BOOKING', 'PAYMENTS', 'DELIVERY',
  'BRANCHES', 'EMPLOYEES', 'INVENTORY', 'LOYALTY', 'PROMOCODES', 'MARKETING',
  'MESSAGES', 'ANALYTICS', 'TELEGRAM',
  // declared, gated off in MVP
  'POS', 'FINANCE', 'SUPPLIERS', 'AI', 'AUTOMATION',
] as const;
